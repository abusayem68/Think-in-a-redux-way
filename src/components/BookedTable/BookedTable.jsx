...
import { deleteFlight } from '../../redux/bookingFlight/actions';

const BookedTable = ({ flightInfo }) => {
  const { id, from, to, date, guests, ticketClass } = flightInfo;
  const dispatch = useDispatch();

  const handleDeleteBookedFlight = (id) => {
    ...
    <tr className="lws-bookedTable text-black">
      ...
      <td className="px-6 py-4 text-center">
        <div className="flex justify-center gap-4">
          <button
            onClick={() => handleDeleteBookedFlight(id)}
